        ...
        <div className={styles.mainContainer}>
            ...
            <section className={styles.sectionContainer}>
                <div className={styles.subtitleAndButtonContainer}>
                    ...
                    <button className={styles.viewButton} name="functionalities" onClick={handleView}>{view.functionalities ? HIDE_ICON : SHOW_ICON}</button>
                </div>
            ...
            <section className={styles.sectionContainer}>
                <div className={styles.subtitleAndButtonContainer}>
                    ...
                    <button className={styles.viewButton} name="contact" onClick={handleView}>{view.contact ? HIDE_ICON : SHOW_ICON}</button>
                </div>
                {view.contact && 
                <div className={styles.dataContainer}>
